...
Public Class personal
    ...
    Private Sub btnSi_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSi.Click
        ...
        If ronda = 0 Then
            Dim sql As String = ("INSERT INTO personal5 (DUIDI, NOMBRE1, APELLIDO1, JRV, ID_CARGO, COD_USUARIO, ID_ESTADO, ID_IMAGEN, DUI, ID_PROCEDE) VALUES (:DUIDI, :NOMBRE1, :APELLIDO1, :JRV, :ID_CARGO, :COD_USUARIO, :ID_ESTADO, :ID_IMAGEN, :DUI, :ID_PROCEDE)")
    ...
    Private Sub mostrarAlcaldes()
        Try
            ...
            If lector.HasRows Then
                ...
                'Aqui Agregare la funcion para que mande la imagen siempre y cuando el estado sea menor que 10
                Dim sqlmenor As String = "select imagenalc from imagen where id_imagen=:ID "
                Dim comandomenor As New OracleCommand(sqlmenor, con)
                comandomenor.Parameters.Add(":ID", OracleType.VarChar, 30).Value = txtjrv.Text
                Dim lectormenor As OracleDataReader = Nothing
                con.Open()
